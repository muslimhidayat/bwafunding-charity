      ...
      <div class="row">
        ...
        <div class="col-lg-4 col-md-6 footer-widget">
          ...
          <ul class="xs-info-list">
            <li>
              <i class="fa fa-home" />Jl. Barukang Raya No. 124, Makassar
              Sulawesi Selatan.
            </li>
            <li>
            ...
            <li>
              <i class="fa fa-envelope-o" /><a href="mailto:yourname@domain.com">muslimhidayat@gmail.com</a>
            </li>
          </ul>
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="xs-copyright-text">
            <p>&copy; Copyright 2020 CharityCulling - All Right's Reserved</p>
          </div>
        </div>
        <div class="col-md-6">
